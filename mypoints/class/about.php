...
class MypointsAbout
{
    ...
    {
        xoops_loadLanguage('about', 'mypoints');
        $this->_aboutTitle = $aboutTitle;

        $this->_lang_developer_contributor = _AB_MYPOINTS_DEVELOPER_CONTRIBUTOR;
        $this->_lang_developer_website = _AB_MYPOINTS_DEVELOPER_WEBSITE;
        $this->_lang_developer_email = _AB_MYPOINTS_DEVELOPER_EMAIL;
        $this->_lang_developer_credits = _AB_MYPOINTS_DEVELOPER_CREDITS;
        $this->_lang_module_info = _AB_MYPOINTS_MODULE_INFO;
        $this->_lang_module_status = _AB_MYPOINTS_MODULE_STATUS;
        $this->_lang_module_release_date =_AB_MYPOINTS_MODULE_RELEASE_DATE ;
        $this->_lang_module_demo = _AB_MYPOINTS_MODULE_DEMO;
        $this->_lang_module_support = _AB_MYPOINTS_MODULE_SUPPORT;
        $this->_lang_module_bug = _AB_MYPOINTS_MODULE_BUG;
        $this->_lang_module_submit_bug = _AB_MYPOINTS_MODULE_SUBMIT_BUG;
        $this->_lang_module_feature = _AB_MYPOINTS_MODULE_FEATURE;
        $this->_lang_module_submit_feature = _AB_MYPOINTS_MODULE_SUBMIT_FEATURE;
        $this->_lang_module_disclaimer = _AB_MYPOINTS_MODULE_DISCLAIMER;
        $this->_lang_author_word = _AB_MYPOINTS_AUTHOR_WORD;
        $this->_lang_version_history = _AB_MYPOINTS_VERSION_HISTORY;
